...
def get_comp_form_sixteen():
    ...
    random_composition_form = random.choice(comp_form_data["sixteenBarForms"])
...
if __name__ == "__get_comp_form_sixteen__":
    get_comp_form_sixteen()
